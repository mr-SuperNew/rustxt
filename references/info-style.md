...
8. Метафора оправдана только тогда, когда она короче буквального объяснения. Образ работает как ярлык, а не как декорация. Если метафора удлиняет текст ради красоты -- убрать, сказать прямо. Тест: метафора сокращает путь к пониманию или удлиняет его? Второй тест, только для объяснительного текста и только для образа, который стоит ВМЕСТО объяснения механизма: что за образом физически происходит? Ответа нет -- образ пустой, заменить механизмом или удалить. Ответ есть, но механизм описан неверно -- ложная точность, чинить механизм; «неверно» -- это когда читатель, поверив образу, сделает неправильный практический вывод, а не когда образ упрощает. Тест не применяется к устойчивым идиомам и разговорным глаголам-окраскам («танцы с бубнами», «гонял на модели», «выдаёт себя с головой»), к чужой прямой речи и к опорному образу всего текста (три и более употреблений): опорный образ определить один раз при вводе и дальше пользоваться свободно. К художественному тексту тест не применять.
...
Давление на согласие читателя через конструкции «это и так понятно, не спорь». Опасны тем, что снимают обязанность автора обосновывать.

слово|замена
очевидно|убрать или обосновать: почему очевидно и для кого?
понятно, что|убрать; дать основание вывода
простое решение|убрать «простое» или признать сложность, которую видит читатель
ясно, что|убрать
само собой|убрать
разумеется|убрать
как известно|убрать (уже и в «Вода»; дублируется намеренно -- категория важнее)
общеизвестно|убрать или указать источник
не секрет, что|убрать
конечно же|убрать
...
11. Минус в первом абзаце, не в подвале. Оговорка, риск, ограничение, неудобная цифра -- в начале или сразу после главного тезиса. Не мелким шрифтом внизу, не сноской, не после двух экранов описания. Примеры: «работает только на iOS 16+» сразу, а не после списка фич; «3 месяца до результата» в лиде, а не «вы можете увидеть изменения уже через несколько недель» с расчётом что не дочитают. Читатель обнаружит минус всё равно -- или у себя на практике, или по отзывам. Спрятанный минус рушит доверие сильнее, чем открытый. Честность укрепляет доверие; это не пессимизм, а уважение.
...
## H. Когда правила гнутся

Разделы B-G применяются к функциональным и информационным текстам: бизнес-письмо, КП, статья, инструкция, документация, описание продукта, лендинг, отчёт, техдок. Эти правила частично не работают для:

1. Художественных текстов -- метафоры, ритм, длинные сравнения здесь работают по своим законам. Info-style их калечит.
2. Личных постов, где доминирует голос автора -- голос побеждает форму. Длинные предложения, ритмические повторы, характерные обороты -- разрешены. Базовая гигиена остаётся (факты, честность, уважение к читателю).
3. Поэзии, прозы, сценариев -- другие законы вообще. Info-style здесь неприменим.
4. Юмористического контента -- преувеличения, оценки, гиперболы часть жанра.

Тест при сомнении: текст должен донести информацию или произвести впечатление?
- Для первого -- все правила B-G.
- Для второго -- голос имеет приоритет, но гигиена (факты, честность, уважение) остаётся.

Форма гнётся, гигиена -- нет. Манипуляции запрещены на любом регистре. Скрытая реклама тоже. Подмена тезиса тоже.

При конфликте голоса и формы побеждает голос. При конфликте голоса и честности побеждает честность.
